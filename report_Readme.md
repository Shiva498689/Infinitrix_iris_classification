    ...
    About the Dataset :
    The Dataset is taken from the kaggle with 150 datapoints but it is than mixed with some more datapoints generated by AI taking it to something around 160 . The Dataset comprises of 5 Columns namely each
